...
export const ISSUE_COMMENT_ON_PR_EVENT = {
  ...
  event: {
    ...
    issue: {
      number: MOCK_PR_DATA.number,
      pull_request: { url: `https://api.github.com/repos/${MOCK_REPO_INFO.owner}/${MOCK_REPO_INFO.name}/pulls/${MOCK_PR_DATA.number}` }, // Presence indicates this is a PR
      state: 'open',
    },
    comment: {
      id: 789,
  ...
  payload: {
    ...
    issue: {
      number: MOCK_PR_DATA.number,
      pull_request: { url: `https://api.github.com/repos/${MOCK_REPO_INFO.owner}/${MOCK_REPO_INFO.name}/pulls/${MOCK_PR_DATA.number}` },
      state: 'open',
    },
    comment: {
      id: 789,
