...
export declare type StepIdentifierUsingIndex = {
    index: number;
    mockWith: GithubWorkflowStep | string;
};
export declare type StepIdentifierUsingBefore = {
    before: number | string;
    mockWith: GithubWorkflowStep;
};
export declare type StepIdentifierUsingAfter = {
    after: number | string;
    mockWith: GithubWorkflowStep;
};
...
export declare function isStepIdentifierUsingRun(step: StepIdentifier): step is StepIdentifierUsingRun;
export declare function isStepIdentifierUsingIndex(step: StepIdentifier): step is StepIdentifierUsingIndex;
export declare function isStepIdentifierUsingBefore(step: StepIdentifier): step is StepIdentifierUsingBefore;
export declare function isStepIdentifierUsingAfter(step: StepIdentifier): step is StepIdentifierUsingAfter;
export declare function isStepIdentifierUsingBeforeOrAfter(step: StepIdentifier): step is StepIdentifierUsingBefore | StepIdentifierUsingAfter;
