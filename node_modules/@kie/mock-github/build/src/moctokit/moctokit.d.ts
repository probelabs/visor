import { EndpointMocker } from "../endpoint-mocker/abstract-endpoint-mocker";
export declare class Moctokit extends EndpointMocker {
    private _rest;
    constructor(baseUrl?: string, allowUnmocked?: boolean);
    get rest(): {
        actions: {
