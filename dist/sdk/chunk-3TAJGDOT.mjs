...
var PRReviewer = class {
  ...
  async reviewPR(owner, repo, prNumber, prInfo, options = {}) {
    ...
    if (config && checks && checks.length > 0) {
      const { CheckExecutionEngine: CheckExecutionEngine2 } = await import("./check-execution-engine-NCPJ2LIK.mjs");
        ...
        try {
          ...
          for (const depId of directDeps) {
            ...
            const hasFatalFailure = (depRes.issues || []).some((issue) => {
              const id = issue.ruleId || "";
              return id === "command/execution_error" || id.endsWith("/command/execution_error") || id === "command/transform_js_error" || id.endsWith("/command/transform_js_error") || id === "command/transform_error" || id.endsWith("/command/transform_error") || id.endsWith("/forEach/iteration_error") || id === "forEach/undefined_output" || id.endsWith("/forEach/undefined_output");
            });
...
//# sourceMappingURL=chunk-3TAJGDOT.mjs.map