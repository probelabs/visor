      ...
      async load(specs) {
        ...
        for (const spec of specs) {
          if (spec.name === "ndjson-sink") {
            ...
            const { GitHubFrontend } = await import("./github-frontend-UFR7KE64.mjs");
            ...
            const { A2AFrontend } = await import("./a2a-frontend-BD2YVQK6.mjs");
...
//# sourceMappingURL=host-WDAZA2DV.mjs.map