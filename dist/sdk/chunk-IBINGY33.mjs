...
var PRReviewer = class {
  ...
  async reviewPR(owner, repo, prNumber, prInfo, options = {}) {
    ...
    if (config && checks && checks.length > 0) {
      const { CheckExecutionEngine: CheckExecutionEngine2 } = await import("./check-execution-engine-HOS2Y6NV.mjs");
...
${expr}
  ...
  async renderCheckContent(checkName, reviewSummary, checkConfig, _prInfo) {
    ...
    let templateContent;
    let usingBuiltInTemplate = false;
...
//# sourceMappingURL=chunk-IBINGY33.mjs.map