      ...
      async load(specs) {
        ...
        for (const spec of specs) {
          if (spec.name === "ndjson-sink") {
            ...
            const { GitHubFrontend } = await import("./github-frontend-BAHULWMB.mjs");
            ...
            const { EmailFrontend } = await import("./email-frontend-WSNADJPI.mjs");
            ...
            const { A2AFrontend } = await import("./a2a-frontend-GODYMU35.mjs");
...
//# sourceMappingURL=host-PRF22TYA.mjs.map