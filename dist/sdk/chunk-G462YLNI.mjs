...
async function handleRouting(context, state, transition, emitEvent, routingContext) {
  ...
  if (checkConfig.on_finish) {
    logger.info(`[Routing] on_finish decision for ${checkId}: forEach=${!!checkConfig.forEach}, processHere=${shouldProcessOnFinishHere}`);
  }
...
//# sourceMappingURL=chunk-G462YLNI.mjs.map