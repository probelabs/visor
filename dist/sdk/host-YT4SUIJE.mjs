      ...
      async load(specs) {
        ...
        for (const spec of specs) {
          if (spec.name === "ndjson-sink") {
            ...
            const { GitHubFrontend } = await import("./github-frontend-7SLJ6RFN.mjs");
            ...
            const { A2AFrontend } = await import("./a2a-frontend-QFRXCLTQ.mjs");
...
//# sourceMappingURL=host-YT4SUIJE.mjs.map