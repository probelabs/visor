      ...
      async load(specs) {
        ...
        for (const spec of specs) {
          if (spec.name === "ndjson-sink") {
            ...
            const { GitHubFrontend } = await import("./github-frontend-AQ3Y6K64.mjs");
            ...
            const { A2AFrontend } = await import("./a2a-frontend-BGML7QD7.mjs");
...
//# sourceMappingURL=host-QPJRFEVV.mjs.map