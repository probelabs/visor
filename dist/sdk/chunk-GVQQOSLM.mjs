...
var PRReviewer = class {
  ...
  async reviewPR(owner, repo, prNumber, prInfo, options = {}) {
    ...
    if (config && checks && checks.length > 0) {
      const { CheckExecutionEngine: CheckExecutionEngine2 } = await import("./check-execution-engine-VGU4LOTK.mjs");
...
${expr}`;
  ...
  async renderCheckContent(checkName, reviewSummary, checkConfig, _prInfo) {
    ...
    const { createExtendedLiquid: createExtendedLiquid2 } = await import("./liquid-extensions-4PVSRZ3X.mjs");
    ...
    const { withPermissionsContext } = await import("./liquid-extensions-4PVSRZ3X.mjs");
...
//# sourceMappingURL=chunk-GVQQOSLM.mjs.map