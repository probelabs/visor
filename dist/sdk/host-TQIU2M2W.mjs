      ...
      async load(specs) {
        ...
        for (const spec of specs) {
          if (spec.name === "ndjson-sink") {
            ...
            const { GitHubFrontend } = await import("./github-frontend-V5GCOOAN.mjs");
            ...
            const { A2AFrontend } = await import("./a2a-frontend-HV4I4X5Q.mjs");
...
//# sourceMappingURL=host-TQIU2M2W.mjs.map