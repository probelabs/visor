      ...
      async load(specs) {
        ...
        for (const spec of specs) {
          if (spec.name === "ndjson-sink") {
            ...
            const { GitHubFrontend } = await import("./github-frontend-QVMVUL3Y.mjs");
            ...
            const { A2AFrontend } = await import("./a2a-frontend-6FNPD53G.mjs");
...
//# sourceMappingURL=host-RVLIZMTE.mjs.map