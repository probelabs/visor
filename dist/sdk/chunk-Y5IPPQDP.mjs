...
var PRReviewer = class {
  ...
  async reviewPR(owner, repo, prNumber, prInfo, options = {}) {
    ...
    if (config && checks && checks.length > 0) {
      const { CheckExecutionEngine: CheckExecutionEngine2 } = await import("./check-execution-engine-JPBIDHWF.mjs");
        ...
        if (process.env.VISOR_DEBUG === "true") {
          ...
          if (ov) {
            ...
            if (ov.tags) {
              ...
              try {
                logger.info(`[github-ops] outputs.overview.tags['review-effort']=${String(ov.tags["review-effort"])}`);
              } catch {
              }
            }
          }
      ...
      try {
        ...
        for (const result of dependencyResults.values()) {
          ...
          if (tags && typeof tags === "object") {
            ...
            if (effort !== void 0 && effort !== null) derived.push(`review/effort:${String(effort)}`);
          }
        }
        values = derived;
        if (process.env.VISOR_DEBUG === "true") {
    ...
    try {
      switch (cfg.op) {
        case "labels.add": {
          ...
          try {
            if (process.env.VISOR_OUTPUT_FORMAT !== "json") logger.step(`[github-ops] labels.add -> ${JSON.stringify(values)}`);
          } catch {
          }
...
//# sourceMappingURL=chunk-Y5IPPQDP.mjs.map