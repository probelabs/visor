...
var PRReviewer = class {
  ...
  async reviewPR(owner, repo, prNumber, prInfo, options = {}) {
    ...
    if (config && checks && checks.length > 0) {
      const { CheckExecutionEngine: CheckExecutionEngine2 } = await import("./check-execution-engine-JU3Z7ZFE.mjs");
...
${expr}
          ...
          if (target) {
            ...
            if (!allAncestors.includes(target)) {
              ...
              if (onSuccess.goto_event) {
                const elevated = await this.elevateContextToPullRequest(
                  { ...prInfo, eventType: onSuccess.goto_event },
                  onSuccess.goto_event,
                  log2,
                  debug
                );
                prInfoForInline = elevated || { ...prInfo, eventType: onSuccess.goto_event };
              ...
              try {
                ...
                try {
                  res.issues = [...res.issues || [], ...forwardIssues];
                } catch {
                }
              } finally {
  ...
  async renderCheckContent(checkName, reviewSummary, checkConfig, _prInfo) {
    ...
    const { createExtendedLiquid: createExtendedLiquid2 } = await import("./liquid-extensions-5MPSHN3A.mjs");
    ...
    const { withPermissionsContext } = await import("./liquid-extensions-5MPSHN3A.mjs");
...
//# sourceMappingURL=chunk-K7X5SLGC.mjs.map