        ...
        try {
          ...
          if (workspace && typeof workspace.isEnabled === "function" && workspace.isEnabled()) {
            ...
            if (projectPaths.length === 0 && mainProjectPath) {
              ...
              logger.debug(`[AI Provider] No external projects - including main project as fallback: ${mainProjectPath}`);
            } else if (mainProjectPath) {
              logger.debug(`[AI Provider] Excluding main project (visor) from allowedFolders: ${mainProjectPath}`);
            }
            ...
            if (unique.length > 0 && workspaceRoot) {
              ...
              logger.debug(`[AI Provider]   mainProjectPath (excluded unless fallback): ${mainProjectPath || "N/A"}`);
...
//# sourceMappingURL=chunk-YORNZRGJ.mjs.map