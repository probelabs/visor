...
} from "./chunk-U56FQ6ZC.mjs";
import {
  DependencyResolver,
  WorkflowRegistry
} from "./chunk-BY7H543S.mjs";
import {
  init_logger,
  logger,
  logger_exports
...
var PRReviewer = class {
  ...
  async reviewPR(owner, repo, prNumber, prInfo, options = {}) {
    ...
    if (config && checks && checks.length > 0) {
      const { CheckExecutionEngine: CheckExecutionEngine2 } = await import("./check-execution-engine-M7A7B44X.mjs");
...
var commandExecutor = CommandExecutor.getInstance();
...
init_logger();
init_sandbox();
var ScriptCheckProvider = class extends CheckProvider {
  liquid;
  constructor() {
    super();
    this.liquid = createExtendedLiquid({
...
var WorkflowCheckProvider = class extends CheckProvider {
  registry;
  executor;
  liquid;
  constructor() {
...
${expr}`;
  ...
  async renderCheckContent(checkName, reviewSummary, checkConfig, _prInfo) {
    ...
    const { createExtendedLiquid: createExtendedLiquid2 } = await import("./liquid-extensions-AMOOB3VC.mjs");
    ...
    const { withPermissionsContext } = await import("./liquid-extensions-AMOOB3VC.mjs");
...
//# sourceMappingURL=chunk-R75ZEMYG.mjs.map