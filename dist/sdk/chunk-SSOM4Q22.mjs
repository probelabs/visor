      ...
      try {
        ...
        if (process.env.VISOR_TRACE_REPORT === "true") {
          ...
          try {
            ...
            const ts = (/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-");
            const jsonPath = path2.join(outDir, `${ts}.trace.json`);
            const htmlPath = path2.join(outDir, `${ts}.report.html`);
            let data = { spans: [] };
            if (fs2.existsSync(jsonPath)) {
              try {
                data = JSON.parse(fs2.readFileSync(jsonPath, "utf8"));
              } catch {
                data = { spans: [] };
              }
            }
            ...
            fs2.writeFileSync(jsonPath, JSON.stringify(data, null, 2), "utf8");
...
//# sourceMappingURL=chunk-SSOM4Q22.mjs.map