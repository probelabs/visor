      ...
      async load(specs) {
        ...
        for (const spec of specs) {
          if (spec.name === "ndjson-sink") {
            ...
            const { GitHubFrontend } = await import("./github-frontend-WPTKI4AY.mjs");
            ...
            const { A2AFrontend } = await import("./a2a-frontend-YTXQGUDH.mjs");
...
//# sourceMappingURL=host-6HV5FMD7.mjs.map