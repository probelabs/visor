      ...
      async load(specs) {
        ...
        for (const spec of specs) {
          if (spec.name === "ndjson-sink") {
            ...
            const { GitHubFrontend } = await import("./github-frontend-3N2NLO66.mjs");
            ...
            const { TuiFrontend } = await import("./tui-frontend-S546M7A7.mjs");
...
//# sourceMappingURL=host-ONVMEHAA.mjs.map