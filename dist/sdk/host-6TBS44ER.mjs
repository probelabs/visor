      ...
      async load(specs) {
        ...
        for (const spec of specs) {
          if (spec.name === "ndjson-sink") {
            ...
            const { GitHubFrontend } = await import("./github-frontend-F2YCPK6H.mjs");
            ...
            const { A2AFrontend } = await import("./a2a-frontend-FUJRKHJB.mjs");
...
//# sourceMappingURL=host-6TBS44ER.mjs.map