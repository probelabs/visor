...
var PRReviewer = class {
  ...
  async reviewPR(owner, repo, prNumber, prInfo, options = {}) {
    ...
    if (config && checks && checks.length > 0) {
      const { CheckExecutionEngine: CheckExecutionEngine2 } = await import("./check-execution-engine-6Y7OMGGV.mjs");
...
${expr}`;
  ...
  async renderCheckContent(checkName, reviewSummary, checkConfig, _prInfo) {
    ...
    const { createExtendedLiquid: createExtendedLiquid2 } = await import("./liquid-extensions-3NZT46JV.mjs");
    ...
    const { withPermissionsContext } = await import("./liquid-extensions-3NZT46JV.mjs");
    ...
    try {
      const { emitMermaidFromMarkdown } = await import("./mermaid-telemetry-RS3EHVEA.mjs");
...
//# sourceMappingURL=chunk-IRCSXP4B.mjs.map