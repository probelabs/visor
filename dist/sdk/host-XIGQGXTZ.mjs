      ...
      async load(specs) {
        ...
        for (const spec of specs) {
          if (spec.name === "ndjson-sink") {
            ...
            const { GitHubFrontend } = await import("./github-frontend-C6ZOBZ5K.mjs");
            ...
            const { A2AFrontend } = await import("./a2a-frontend-WZXAZKZV.mjs");
...
//# sourceMappingURL=host-XIGQGXTZ.mjs.map