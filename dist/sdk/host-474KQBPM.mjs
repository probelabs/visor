      ...
      async load(specs) {
        ...
        for (const spec of specs) {
          if (spec.name === "ndjson-sink") {
            ...
            const { GitHubFrontend } = await import("./github-frontend-OENNC73T.mjs");
            ...
            const { A2AFrontend } = await import("./a2a-frontend-NUHOQ2OZ.mjs");
...
//# sourceMappingURL=host-474KQBPM.mjs.map